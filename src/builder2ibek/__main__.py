...
from builder2builder2ibek import __version__
...
@cli.command()
def builder2ibek_schema(
    output: Path = typer.Argument(..., help="The filename to write the schema to")
):
    """Produce the JSON global schema for all <support_module>.builder2ibek.defs.yaml files"""
...
def ioc_schema(
    ...
    """
    Create a json schema from a <support_module>.builder2ibek.defs.yaml file
    """
