...
save_restoreSet_status_prefix BL11I-VA-IOC-01:
...
ipacAddHy8002("4, 2")
# record above carrier card ID 0 in 'CARD4'
epicsEnvSet CARD4 0
ipacAddHy8002("5, 2")
# record above carrier card ID 1 in 'CARD5'
epicsEnvSet CARD5 1
...
DLS8515Configure(40, $(CARD4), $(Vec4))
DLS8515Configure(41, $(CARD4), $(Vec5))

# DLS8516Configure(card_id, carrier_index, interrupt_vector)
DLS8516Configure(42, $(CARD4), $(Vec6))
